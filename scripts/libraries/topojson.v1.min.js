...
topojson = function() {
    function e(e, n) {
        ...
        n.forEach(function(e) {
            var n, a, i = t(e),
                u = i[0],
                c = i[1];
            if (n = o[u]) if (delete o[n.end], n.push(e), n.end = c, a = r[c]) {
                delete r[a.start];
            ...
            else if (n = r[c]) if (delete r[n.start], n.unshift(e), n.start = u, a = o[u]) {
                delete o[a.end];
            ...
            else if (n = r[u]) if (delete r[n.start], n.unshift(~e), n.start = c, a = o[c]) {
                delete o[a.end];
                var f = a === n ? n : a.concat(n);
                r[f.start = a.start] = o[f.end = n.end] = f
            } else if (a = r[c]) {
            ...
            else if (n = o[c]) if (delete o[n.end], n.push(~e), n.end = u, a = o[u]) {
                delete r[a.start];
                var s = a === n ? n : n.concat(a);
                r[s.start = n.start] = o[s.end = a.end] = s
            } else if (a = r[u]) {
    ...
    function u(e) {
        ...
        e.forEach(r);
        for (var c in o) for (var s = o[c], f = s.length, l = 0; f > l; ++l) for (var d = l + 1; f > d; ++d) {
            var p, v = s[l],
                h = s[d];
